      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-between items-center h-16">
            {/* Logo */}
            <Link to="/" className="text-[#ff00cc] glitch font-glitch text-xl sm:text-2xl uppercase glitch-move">
            ...
            <div className="hidden md:flex gap-8 text-sm font-mono tracking-widest uppercase">
              <Link to="/" className="hover:text-[#ff00cc] text-white transition-all glitch-hover">Home</Link>
              <Link to="/about" className="hover:text-[#ff00cc] text-white transition-all glitch-hover">About</Link>
              <a
                href="/login"
                target="_blank"
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-black border-t border-[#444] px-6 pb-4 pt-2 text-sm font-mono uppercase space-y-4">
            <Link to="/" className="block text-white hover:text-[#ff00cc] glitch-hover">Home</Link>
            <Link to="/about" className="block text-white hover:text-[#ff00cc] glitch-hover">About</Link>
            <a
              href="/login"
              target="_blank"
              rel="noopener noreferrer"
