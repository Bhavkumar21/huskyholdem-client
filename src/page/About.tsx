...
const GlitchText = ({ children, intensity = "medium" }: { children: React.ReactNode; intensity?: "low" | "medium" | "high" }) => {
  ...
  const glitchClasses = {
    low: "after:content-[attr(data-text)] after:absolute after:left-[2px] after:text-[#559CF8] after:top-0 after:w-full after:h-full after:z-[-1]",
    medium: "after:content-[attr(data-text)] after:absolute after:left-[2px] after:text-[#559CF8] after:top-0 after:w-full after:h-full after:z-[-1] before:content-[attr(data-text)] before:absolute before:left-[-2px] before:text-[#FFFFFF] before:top-0 before:w-full before:h-full before:z-[-1]",
    high: "after:content-[attr(data-text)] after:absolute after:left-[4px] after:text-[#559CF8] after:top-0 after:w-full after:h-full after:z-[-1] before:content-[attr(data-text)] before:absolute before:left-[-4px] before:text-[#FFFFFF] before:top-0 before:w-full before:h-full before:z-[-1]"
  };
...
const InfoCard = ({ title, children }: any) => {
  return (
    <div className="bg-black bg-opacity-70 border border-gray-800 p-6 mb-8 relative overflow-hidden group hover:border-[#FFFFFF] transition-colors duration-300">
      {/* Corner decorations */}
      <div className="absolute top-0 right-0 w-8 h-8 border-t border-r border-[#559CF8] opacity-50"></div>
      <div className="absolute bottom-0 left-0 w-8 h-8 border-b border-l border-[#559CF8] opacity-50"></div>
      ...
      <h3 className="text-xl font-mono text-[#FFFFFF] mb-4 flex items-center">
        <span className="inline-block w-2 h-2 bg-[#FFFFFF] mr-2"></span>
      ...
      {/* Bottom decoration */}
      <div className="w-full h-0.5 mt-4 bg-gradient-to-r from-transparent via-[#559CF8] to-transparent opacity-30"></div>
    </div>
  );
};
...
const TeamMember = ({ name, role }: any) => {
  return (
    <div className="flex items-center mb-3 group">
      <div className="w-2 h-2 bg-[#FFFFFF] mr-3 group-hover:bg-[#559CF8] transition-colors duration-300"></div>
      <div>
  ...
  return (
    <section className="py-16 px-6 max-w-6xl mx-auto text-white relative min-h-screen">
      ...
      <div className="mb-12 border-b border-gray-800 pb-4 flex flex-col md:flex-row md:items-end justify-between">
        <div>
          ...
          <h1 className="text-5xl font-mono font-bold tracking-tighter mb-2">
            <span className="text-[#559CF8]"><GlitchText intensity="high">HUSKY</GlitchText></span>
            <span className="text-white">::</span>
            <span className="text-[#FFFFFF]"><GlitchText intensity="high">HOLD'EM</GlitchText></span>
          </h1>
          <p className="font-mono text-sm text-gray-400">// OFFICIAL POKERBOT TOURNAMENT <span className="text-[#FFFFFF]">v2.5</span></p>
        </div>
        <div className="mt-4 md:mt-0">
          <p className="font-mono text-xs text-gray-500">
            <span className="text-[#559CF8]">SYSTEM</span>::<span className="text-[#FFFFFF]">ABOUT</span>
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="md:col-span-2">
          <InfoCard title="ABOUT THE TOURNAMENT">
            <p>
              Husky Hold'em is the official poker bot tournament hosted by the <span className="text-[#FFFFFF]"><a style={{color: "#FFFFFF"}} href="https://atcuw.org/" className="underline">[Algorithmic Trading Club]</a></span> at the University of Washington. Competitors build intelligent agents that play Texas Hold'em and compete in a real-time tournament simulation.
            </p>
            <p className="mt-4">
          ...
          <InfoCard title="WHY POKERBOTS">
            ...
            <div className="mt-6 p-3 bg-black bg-opacity-50 border-l-2 border-[#FFFFFF] flex gap-3 items-center group hover:bg-opacity-70 transition-all duration-300">
              <span className="text-2xl">📖</span>
              <a 
                href="https://kipiilier.notion.site/Husky-Hold-em-Wiki-1eb8f86cec5c80b9b5e7cc2963162ca2?pvs=74" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-[#FFFFFF] underline hover:text-[#559CF8] transition-colors duration-300"
              >
        ...
        <div className="md:col-span-1">
          ...
          <div className="bg-black bg-opacity-70 border border-gray-800 p-6 mb-8 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#559CF8] to-[#FFFFFF]"></div>
            
            <h3 className="text-xl font-mono text-[#559CF8] mb-6">
              <GlitchText>TEAM::MEMBERS</GlitchText>
            </h3>
            
            <div className="mb-6">
              <h4 className="font-mono text-sm text-[#FFFFFF] mb-3 uppercase tracking-wider">Developers</h4>
              {developers.map((dev) => (
            ...
            <div className="mb-6">
              <h4 className="font-mono text-sm text-[#FFFFFF] mb-3 uppercase tracking-wider">Advisors</h4>
              {advisors.map((adv) => (
            ...
            <div className="w-full border-t border-dashed border-gray-800 pt-4 mt-6">
              <p className="font-mono text-xs text-gray-500">
                <span className="text-[#559CF8]">[STATUS]</span> Active members: {developers.length + advisors.length}
              </p>
            </div>
          </div>
          ...
          <div className="bg-black bg-opacity-70 border border-gray-800 p-4 mb-8">
            <h4 className="font-mono text-sm text-[#FFFFFF] mb-2">SYSTEM::STATUS</h4>
            <div className="space-y-2 font-mono text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-[#FFFFFF]">OPEN</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Next event:</span>
                <span className="text-[#559CF8]">BOT_SUBMISSION</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mt-16 relative">
        <h3 className="text-xl font-mono text-[#559CF8] mb-6 flex items-center">
          <span className="inline-block w-2 h-2 bg-[#559CF8] mr-2"></span>
        ...
        <div className="grid grid-cols-6 grid-rows-6 gap-4 h-[60vh]">
          <div className="col-span-2 row-span-6 bg-[#0f0f0f] border border-gray-800 flex items-center justify-center relative group overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#559CF8] to-transparent opacity-50"></div>
            <div className="absolute bottom-0 right-0 w-full h-0.5 bg-gradient-to-l from-[#559CF8] to-transparent opacity-50"></div>
            <span className="font-mono text-gray-500 group-hover:text-[#559CF8] transition-colors duration-300">NEURAL::ACCESS</span>
          </div>
          ...
          <div className="col-span-4 row-span-3 bg-cover bg-center border border-gray-800 relative group" style={{ backgroundImage: `url(${img1})` }}>
            <div className="absolute inset-0 bg-black bg-opacity-60 opacity-100 group-hover:opacity-0 transition-opacity duration-500 flex items-center justify-center">
              <span className="font-mono text-[#FFFFFF]">// TOURNAMENT SESSION 2024</span>
            </div>
            <div className="absolute bottom-0 left-0 w-full p-2 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <span className="text-[#559CF8]">[IMAGE::01]</span> Annual competition
            </div>
          </div>
          ...
          <div className="col-span-3 row-span-3 bg-cover bg-center border border-gray-800 relative group" style={{ backgroundImage: `url(${img2})` }}>
            <div className="absolute inset-0 bg-black bg-opacity-60 opacity-100 group-hover:opacity-0 transition-opacity duration-500 flex items-center justify-center">
              <span className="font-mono text-[#FFFFFF]">// STRATEGY SESSION</span>
            </div>
            <div className="absolute bottom-0 left-0 w-full p-2 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <span className="text-[#559CF8]">[IMAGE::03]</span> Workshop event
            </div>
          </div>
          ...
          <div className="col-span-3 row-span-3 bg-[#0f0f0f] border border-gray-800 flex items-center justify-center relative group overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-full h-0.5 bg-gradient-to-l from-[#FFFFFF] to-transparent opacity-50"></div>
            <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#FFFFFF] to-transparent opacity-50"></div>
            <span className="font-mono text-gray-500 group-hover:text-[#FFFFFF] transition-colors duration-300">DATA::STREAM</span>
          </div>
          ...
          <div className="col-span-3 row-span-3 bg-cover bg-center border border-gray-800 relative group" style={{ backgroundImage: `url(${img3})` }}>
            <div className="absolute inset-0 bg-black bg-opacity-60 opacity-100 group-hover:opacity-0 transition-opacity duration-500 flex items-center justify-center">
              <span className="font-mono text-[#FFFFFF]">// CODING INTERFACE</span>
            </div>
            <div className="absolute bottom-0 left-0 w-full p-2 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <span className="text-[#559CF8]">[IMAGE::02]</span> Bot development
            </div>
          </div>
        </div>
      </div>
...
{/* <div className="mt-16 relative bg-black text-white p-4">
      ...
      <div className="grid grid-cols-12 gap-4 h-[80vh]">
        <div className="col-span-6 row-span-4 bg-cover bg-center border border-gray-800 relative group">
          ...
          <div className="absolute bottom-0 left-0 w-full p-2 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <span className="text-[#559CF8]">[IMAGE::01]</span> Annual competition finals
          </div>
        ...
        <div className="col-span-3 row-span-2 bg-cover bg-center border border-gray-800 relative group">
          ...
          <div className="absolute bottom-0 left-0 w-full p-2 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <span className="text-[#559CF8]">[IMAGE::02]</span> Workshop event
          </div>
        ...
        <div className="col-span-3 row-span-2 bg-cover bg-center border border-gray-800 relative group">
          ...
          <div className="absolute bottom-0 left-0 w-full p-2 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <span className="text-[#559CF8]">[IMAGE::03]</span> Bot development
          </div>
        ...
        <div className="col-span-3 row-span-2 bg-cover bg-center border border-gray-800 relative group">
          <div className="absolute inset-0 bg-black bg-opacity-60 opacity-100 group-hover:opacity-0 transition-opacity duration-500 flex items-center justify-center">
            <span className="font-mono text-[#FFFFFF]">// NEURAL NETWORK</span>
          </div>
          <div className="absolute bottom-0 left-0 w-full p-2 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <span className="text-[#559CF8]">[IMAGE::04]</span> Training algorithms
          </div>
        ...
        <div className="col-span-3 row-span-2 bg-cover bg-center border border-gray-800 relative group">
          <div className="absolute inset-0 bg-black bg-opacity-60 opacity-100 group-hover:opacity-0 transition-opacity duration-500 flex items-center justify-center">
            <span className="font-mono text-[#FFFFFF]">// VIRTUAL ARENA</span>
          </div>
          <div className="absolute bottom-0 left-0 w-full p-2 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <span className="text-[#559CF8]">[IMAGE::05]</span> Simulation system
        ...
        <div className="col-span-2 row-span-1 bg-cover bg-center border border-gray-800 relative group">
          ...
          <div className="absolute bottom-0 left-0 w-full p-1 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <span className="text-[#559CF8]">[IMG::06]</span>
          </div>
        ...
        <div className="col-span-2 row-span-1 bg-cover bg-center border border-gray-800 relative group">
          <div className="absolute inset-0 bg-black bg-opacity-70 opacity-100 group-hover:opacity-0 transition-opacity duration-500"></div>
          <div className="absolute bottom-0 left-0 w-full p-1 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <span className="text-[#559CF8]">[IMG::07]</span>
          </div>
        ...
        <div className="col-span-2 row-span-1 bg-cover bg-center border border-gray-800 relative group">
          <div className="absolute inset-0 bg-black bg-opacity-70 opacity-100 group-hover:opacity-0 transition-opacity duration-500"></div>
          <div className="absolute bottom-0 left-0 w-full p-1 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <span className="text-[#559CF8]">[IMG::08]</span>
          </div>
        ...
        <div className="col-span-4 row-span-3 bg-cover bg-center border border-gray-800 relative group">
          <div className="absolute inset-0 bg-black bg-opacity-60 opacity-100 group-hover:opacity-0 transition-opacity duration-500 flex items-center justify-center">
            <span className="font-mono text-[#FFFFFF]">// DEVELOPER TEAM</span>
          </div>
          <div className="absolute bottom-0 left-0 w-full p-2 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <span className="text-[#559CF8]">[IMAGE::09]</span> Hackathon champions
          </div>
        ...
        <div className="col-span-2 row-span-3 bg-cover bg-center border border-gray-800 relative group">
          <div className="absolute inset-0 bg-black bg-opacity-60 opacity-100 group-hover:opacity-0 transition-opacity duration-500 flex items-center justify-center">
            <span className="font-mono text-[#FFFFFF]">// LAB</span>
          </div>
          <div className="absolute bottom-0 left-0 w-full p-2 bg-black bg-opacity-70 font-mono text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <span className="text-[#559CF8]">[IMAGE::10]</span>
          </div>
      ...
      <div className="flex justify-center mt-6 gap-2">
        <div className="w-8 h-1 bg-[#559CF8]"></div>
