  ...
  return (
    <section className="py-16 px-4  min-h-screen flex flex-col items-center justify-center ">
      <div className="relative mb-16">
        <h2 className="text-4xl font-bold text-[#FFFFFF] tracking-widest uppercase relative z-10">
          <span className="text-fuchsia-600">SYS</span>:<span className="text-[#FFFFFF]">TIMELINE</span>
        </h2>
        <div className="absolute -inset-1 bg-[#FFFFFF] opacity-20 blur-md"></div>
      </div>
      
      <div className="max-w-3xl mx-auto relative">
        {/* Vertical line with glow */}
        <div className="absolute left-6 top-4 bottom-6 w-1 bg-gradient-to-b from-fuchsia-600 via-[#FFFFFF] to-fuchsia-600 rounded-full">
          <div className="absolute inset-0 blur-sm bg-gradient-to-b from-fuchsia-600 via-[#FFFFFF] to-fuchsia-600 opacity-70"></div>
        </div>
          ...
          {timelineItems.map((item, idx) => (
            ...
            >
              ...
              <div className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-1/2 flex items-center justify-center">
                ...
                <div className={`absolute w-6 h-6 bg-[#FFFFFF] rounded-full blur-md opacity-70 ${hoveredIndex === idx ? 'animate-pulse' : ''}`}></div>
              </div>
              ...
              <div className={`transition-all duration-300 ${hoveredIndex === idx ? 'translate-x-2' : ''}`}>
                <p className="text-fuchsia-600 text-lg mb-1 flex items-center">
                  <span className="inline-block w-8 text-[#FFFFFF] mr-2">[</span>
                  {item.date}
                  <span className="inline-block w-8 text-[#FFFFFF] ml-2">]</span>
                </p>
                <p className="text-[#FFFFFF] text-xl tracking-wide ml-12">
                  {item.label}
                </p>
              ...
              {/* Glitchy decoration */}
              <div className="absolute top-0 right-0 h-full w-1 bg-gradient-to-b from-transparent via-[#FFFFFF] to-transparent opacity-60"></div>
        ...
        <div className="absolute -top-4 -right-4 w-16 h-16 border-t-2 border-r-2 border-[#FFFFFF] opacity-50"></div>
      ...
      <div className="mt-12 font-mono text-xs text-gray-500 tracking-wider">
        ...
        <p className="mb-2">[SYS:STATUS] <span className="text-[#FFFFFF]">TOURNAMENT_PHASE</span>:<span className="text-fuchsia-600">ESTIMATED</span></p>
        <p>INIT::<span className="text-[#FFFFFF]">PROTOCOL_2025</span></p>
      </div>
    </section>
  );
};
